...
INSERT INTO products (id, name, description, price, image_url, stock_quantity, active) VALUES
(1, 'Tradicional', 'Duas salsichas, batata palha, milho, maionese, ketchup e mostarda.', 14.00, './img/hotdog-tradicional.png', 100, TRUE),
(2, 'Frango', 'Duas salsichas, frango desfiado, batata palha, milho, maionese, ketchup e mostarda.', 18.00, './img/hotdog-frango.png', 100, TRUE),
(3, 'Pizza', 'Duas salsichas, presunto, mucarela, tomate, oregano, batata palha, milho, maionese, ketchup e mostarda.', 18.00, './img/hotdog-pizza.png', 100, TRUE),
(4, 'Chefe', 'Duas salsichas, rucula, requeijao cremoso, alho frito, batata palha, milho, maionese, ketchup e mostarda.', 18.00, './img/hotdog-chefe.png', 100, TRUE),
(5, 'Bacon', 'Duas salsichas, bacon, batata palha, milho, maionese, ketchup e mostarda.', 20.00, './img/hotdog-bacon.png', 100, TRUE),
(6, 'Coca-Cola 350ml', 'Refrigerante Coca-Cola lata 350ml.', 6.00, './img/hot-dog.png', 100, TRUE),
(7, 'Guarana 350ml', 'Refrigerante Guarana lata 350ml.', 5.00, './img/hot-dog.png', 100, TRUE),
(8, 'Fanta 350ml', 'Refrigerante Fanta lata 350ml.', 5.00, './img/hot-dog.png', 100, TRUE),
(9, 'Agua sem gas', 'Garrafa de agua mineral sem gas.', 3.00, './img/hot-dog.png', 100, TRUE),
(10, 'Agua com gas', 'Garrafa de agua mineral com gas.', 3.00, './img/hot-dog.png', 100, TRUE);

SELECT setval('products_id_seq', (SELECT MAX(id) FROM products));

INSERT INTO supplies (name, quantity, unit)
SELECT 'Pao Brioche', 40.0, 'UN'::supply_unit
WHERE NOT EXISTS (SELECT 1 FROM supplies WHERE name = 'Pao Brioche');
